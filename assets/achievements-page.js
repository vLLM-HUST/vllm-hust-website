(function () {
    ...
    const OPEN_UPSTREAM_PRS = [
        ...
        { repository: 'vLLM-Ascend', number: 12343, title: '[Ops][BugFix] Fix Qwen2 compiled-path outputs on Ascend', status: 'ready-evidence', href: 'https://github.com/vllm-project/vllm-ascend/pull/12343' },
    ...
    const UI = {
        en: {
            ...
            readyEvidenceStatus: 'Ready · NPU evidence attached',
        ...
        zh: {
            ...
            readyEvidenceStatus: '已 Ready · 已附 NPU 实测',
