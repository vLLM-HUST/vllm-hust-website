...
(() => {
    ...
    Promise.all([
        fetch('./data/leaderboard_frontier.json?v=sweprefix-tp8-20260924-7',{cache:'no-cache'}).then(r=>{if(!r.ok)throw new Error('Snapshot unavailable');return r.json();}).then(M.validate),
